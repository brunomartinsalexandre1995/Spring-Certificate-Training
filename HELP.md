...
* The original package name 'spring.certificate.training.certificate-topics' is invalid and this project uses 'spring.certificate.training.certificatetopics' instead.
